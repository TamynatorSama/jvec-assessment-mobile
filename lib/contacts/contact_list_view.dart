...
Expanded(child:
            provider.contacts.isEmpty?Column(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
              Opacity(
                opacity: 0.5,
                child: SvgPicture.asset('assets/images/Empty-pana.svg',fit: 
                BoxFit.contain,height: 400,)),
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal:24.0),
                  child: Text("You haven't added any contact yet, click the + icon at the buttom to get started",style: AppTheme.headerTextStyle.override(fontSize: 15,color: Colors.grey),textAlign: TextAlign.center,),
                )
              ],
            ) :AzListView(
